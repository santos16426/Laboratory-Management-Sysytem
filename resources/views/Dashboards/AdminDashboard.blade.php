  ...
  $.ajax
      ({
        ...
        response[4].forEach(function(data){
          ...
          frameDoc.document.write('<tr> <td> <img src="{{ asset("/banner.jpg") }}" style="width:100%; max-width: 350px; padding 0"> </td> <td style="text-align: left; padding-top: 25px; padding: 0; font-size: 10px"> <strong>Company Name:</strong>< Insert Company Name ><br> <strong>Address:</strong>< Insert Company Address ><br><br> <strong>Contact Number:</strong>< Insert Company Tel No. ><br> <strong>Email:</strong>< Insert Company Email > </td> </tr>');
          frameDoc.document.write('</table>');
          frameDoc.document.write('<tr class="information"> <td colspan="2"> <table> <tr><td></td></tr>');
          frameDoc.document.write('<tr> <td> <strong>Patient Name:</strong>'+patient_name+'<br> <strong> Claiming Code:</strong> '+claimcode+'<br> <strong>Website:</strong>< Insert Company Website > </td> <td> </td> <td style="padding-left: 33px"> <strong>Date:</strong> '+moment(date).format('MMMM Do YYYY')+' <br> <strong>Receptionist:</strong>'+emp_name+'<br> <strong>Reffering Employee:</strong>'+ref_name+' </td></tr>');
