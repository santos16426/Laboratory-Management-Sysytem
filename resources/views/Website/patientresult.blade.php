          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                      ...
                      <li><a href="../../index.html">Back to Website&nbsp;&nbsp;<i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
                ...
                <div class="fresh-table toolbar-color-blue">
                    ...
                    <table id="fresh-table" class="table">
                        ...
                        @foreach($transactions as $t)
                            <tr>
                              <td>{{ $t->trans_date }}</td>
                              <td><button class="btn btn-info btn-sm"><i class="fa fa-download"></i>&nbsp; Download Files</button></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
