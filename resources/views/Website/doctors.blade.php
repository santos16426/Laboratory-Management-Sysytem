...
<div class="modal fade" id = "updateModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="/upform" id="upform">
      {{ csrf_field() }}
          ...
          <h4>Edit Doctor</h4>
           <input type="hidden" name="doc_id" id="doc_id">
                  ...
                  <div class="col-md-10 col-md-offset-1">
                     <div class="input-group">
                      <div class="input-group-addon">
                       Doctor Name <sup style="color:red">*</sup>
                     </div>
                    <input  name="docname" id="docname" type="text"  class="form-control input-md" required>
                 </div>
              </div>  
           </div>  
            ...
            <div class="form-group">
                  <div class="col-md-10 col-md-offset-1">
                     <div class="input-group">
                      <div class="input-group-addon">
                       Specialization <sup style="color:red">*</sup>
                     </div>
                    <input  name="specialization" id="specialization" type="text" class="form-control input-md" required>
                 </div>
              </div>  
           </div> 
           ...
           <div class="form-group">
                  <div class="col-md-10 col-md-offset-1">
                    ...
                    <input  name="contact" id="contact" type="text" class="form-control input-md" required>
                 </div>
              </div>  
...
<div class="modal fade" id = "delModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="/delform" id="delform">
      {{ csrf_field() }}
        <div class="modal-body">
          <h4>Delete Doctor</h4>
           <input type="hidden" name="deldoc_id" id="deldoc_id">
...
<div class="modal fade" id = "restoreModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      {{ csrf_field() }}
        <div class="modal-body">
          <h4>Restore Doctor</h4>
           <input type="hidden" name="resdoc_id" id="resdoc_id">
...
<div class="modal fade" id = "newModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form method="post" action="/mewform" id="mewform">
      {{ csrf_field() }}
        <div class="modal-body">
          <h4>New Doctor</h4>
            <div class="form-group">
                  <div class="col-md-10 col-md-offset-1">
                    ...
                    <input  name="newdocname" id="newdocname" type="text"  class="form-control input-md" required>
                 </div>
              </div>  
           </div>  
            ...
            <div class="form-group">
                  <div class="col-md-10 col-md-offset-1">
                    ...
                    <input  name="newspecialization" id="newspecialization" type="text" class="form-control input-md" required>
                 </div>
              </div>  
           </div> 
           ...
           <div class="form-group">
                  <div class="col-md-10 col-md-offset-1">
                    ...
                    <input  name="newcontact" id="newcontact" type="text" class="form-control input-md" required>
                 </div>
              </div>  
        ...
        <div class="space-100"></div>      
                ...
                <div class="fresh-table toolbar-color-blue">
                    ...
                    <table id="fresh-table" class="table">
                        ...
                        <td>
                          <a class="updatebrn btn btn-warning btn-sm btn-fill" onclick="hello({{$t->doctor_id}})" data-id="{{$t->doctor_id}}" href="#updateModal" data-toggle="modal">Update</a>
                          @if($t->status == 1)
                          <a class="updatebrn btn btn-danger btn-sm btn-fill" onclick="del({{$t->doctor_id}})" data-id="{{$t->doctor_id}}" href="#delModal" data-toggle="modal">Delete</a>
                          @else
                          <a class="updatebrn btn btn-success btn-sm btn-fill" onclick="rest({{$t->doctor_id}})" data-id="{{$t->doctor_id}}" href="#restoreModal" data-toggle="modal">Restore</a>
                          @endif
                        </td>
                        </tr>
                        @endforeach
