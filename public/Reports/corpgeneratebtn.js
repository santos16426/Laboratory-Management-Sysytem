				...
				({
					...
					success:function(response){
						...
						Highcharts.chart('barcharts', {
						    ...
						    title: {
						        text: 'Daily Corporate Transaction Report as of '+moment(start_date).format('Do of MMMM, YYYY')
						    },
				...
				({
					...
					success:function(response){
						...
						Highcharts.chart('barcharts', {
						    ...
						    title: {
						        text: 'Weekly Corporate Transaction Report as of '+moment(start_date).format('Do MMMM, YYYY') + ' to '+moment(enddate).format('Do MMMM, YYYY') 
						    },
