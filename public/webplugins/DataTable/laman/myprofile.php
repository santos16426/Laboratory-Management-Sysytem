...
<div class="main">
  ...
  <div class="container">
          ...
          <div class="panel-heading">
            ...
            <div class="panel-body">
              ...
              <ul class="list-group list-group-unbordered">
                ...
                <?php 
                $countproductsearch = "SELECT * FROM product_tbl p LEFT OUTER JOIN user_tbl u ON p.product_user_id=u.user_id LEFT OUTER JOIN producttype_tbl t ON t.producttype_id = p.product_type_id LEFT OUTER JOIN product_status s ON p.product_status = s.productstatus_id WHERE p.product_user_id = $id";
                 $countproductquery = $connect->query($countproductsearch);
                 $countproductquery = mysqli_num_rows($countproductquery);


                 $soldcountproductsearch = "SELECT * FROM product_tbl p LEFT OUTER JOIN user_tbl u ON p.product_user_id=u.user_id LEFT OUTER JOIN producttype_tbl t ON t.producttype_id = p.product_type_id LEFT OUTER JOIN product_status s ON p.product_status = s.productstatus_id WHERE p.product_user_id = $id and p.product_status = 3";
        ...
        <div class="col-md-9">
          ...
          <div class="panel-body">
           <?php 
  $productsearch = "SELECT *,p.product_description as descript FROM product_tbl p LEFT OUTER JOIN user_tbl u ON p.product_user_id=u.user_id LEFT OUTER JOIN producttype_tbl t ON t.producttype_id = p.product_type_id LEFT OUTER JOIN product_status s ON p.product_status = s.productstatus_id WHERE p.product_user_id = $id";
